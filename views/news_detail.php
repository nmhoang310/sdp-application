        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-xs-12">
                ...
                <div class="single-blog-post">
                    <div class="blog-img">
                        <img alt="" src="img/blog/single.jpg">
                    </div>
                    <div class="blog-info">
                        <h3 class="title">How Furniture Is Going To Change Your Business Strategies.</h3>
                        <div class="blog-meta">
                            ...
                            <span><a href="#"><i class="fa fa-eye"></i> views (119)</a></span>
                        </div>
                ...
                <div class="comment-wrapper mt-40 mb-40">
                    ...
                    <ul class="comment-list">
                        ...
                        <li>
                            <div class="single-comment fix">
                                <div class="image float-left"><img src="img/blog/comment-2.jpg" alt=""></div>
                                <div class="content fix">
                                    <div class="head fix">
                                        <div class="author-time">
                                            <h4>Benjamin Estrada</h4>
                                            <span>09 hours ago</span>
                                        </div>
                                        <a href="#">Replay</a>
                                    </div>
                            ...
                            <ul>
                                <li>
                                    <div class="single-comment fix">
                                        <div class="image float-left"><img src="img/blog/comment-3.jpg" alt=""></div>
                                        <div class="content fix">
                                            <div class="head fix">
                                                <div class="author-time">
                                                    <h4>Alice Walters</h4>
                        ...
                        <li>
                            <div class="single-comment fix">
                                <div class="image float-left"><img src="img/blog/comment-4.jpg" alt=""></div>
                                <div class="content fix">
                                    <div class="head fix">
                                        <div class="author-time">
                                            <h4>Ashley Sandoval</h4>
                                            <span>09 hours ago</span>
                                        </div>
                                        <a href="#">Replay</a>
                                    </div>
